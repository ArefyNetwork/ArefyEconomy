...
All notable changes to ArefyEconomy will be documented in this file.
...
#### API
- `ArefyEconomyAPI` - Public static methods for all economy operations
...
| `/eco` | `arefyeconomy.arefyeconomy.command.eco` |
