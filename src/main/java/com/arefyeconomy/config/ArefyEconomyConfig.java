package com.arefyeconomy.config;
...
/**
 * Configuration for ArefyEconomy economy plugin.
 * 
 * All settings are saved to ArefyEconomy.json in the universe folder.
 * 
 * NOTE: BuilderCodec keys MUST start with uppercase (PascalCase)
 */
public class ArefyEconomyConfig {
    
    public static final BuilderCodec<ArefyEconomyConfig> CODEC = BuilderCodec.builder(ArefyEconomyConfig.class, ArefyEconomyConfig::new)
        // Currency settings
    ...
    private String mysqlDatabase = "arefyeconomy";
    ...
    /** Get MySQL database name. @return Database name (default: "arefyeconomy") */
