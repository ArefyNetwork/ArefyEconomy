 ...
 * 
 * <p>ArefyEconomy Core exposes this interface but does NOT implement it.
 * The ArefyEconomyCoins addon implements this and registers via 
 * {@link ArefyEconomyAPI#registerPhysicalCoinsProvider(PhysicalCoinsProvider)}.
 * 
 * <p>Other plugins (like ArefyEconomyJobs) can check if coins are available via
 * {@link ArefyEconomyAPI#isPhysicalCoinsAvailable()} and use the provider.
 * 
 * @author ArefyEconomy
 * @since 1.1.0
 */
