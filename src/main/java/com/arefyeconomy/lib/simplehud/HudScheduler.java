package com.arefyeconomy.lib.simplehud;
 ...
 * 
 * Originally from SimpleHUD-Lib by Terabytez, inlined into ArefyEconomy.
 */
public final class HudScheduler {
    ...
    private static final ScheduledExecutorService EXECUTOR = 
            Executors.newScheduledThreadPool(1, r -> {
                Thread t = new Thread(r, "ArefyEconomy-HudScheduler");
                t.setDaemon(true);
                return t;
            });
